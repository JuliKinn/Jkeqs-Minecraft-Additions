...
public class ModFoods {
    ...
    public static final FoodProperties TARHUN = (new FoodProperties.Builder()).nutrition(5).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 200, 1), 1.0F).alwaysEat().build();
