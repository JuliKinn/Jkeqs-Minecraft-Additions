...
public class ModItems {
    ...
    public static final RegistryObject<Item> CHAINSAW = ITEMS.register("chainsaw",
            () -> new AxeItem(Tiers.IRON, 6, -3.2f, new Item.Properties()));
    ...
    public static final RegistryObject<Item> TARHUN = ITEMS.register("tarhun",
            () -> new HoneyBottleItem(new Item.Properties().food(ModFoods.TARHUN).stacksTo(16)));
    ...
    public static final RegistryObject<Item> ROMANIA_ANTHEM_MUSIC_DISC = ITEMS.register("romania_anthem_music_disc",
            () -> new RecordItem(2, ModSounds.ROMANIA_ANTHEM, new Item.Properties().stacksTo(1), 2400));
    public static final RegistryObject<Item> FRANCE_ANTHEM_MUSIC_DISC = ITEMS.register("france_anthem_music_disc",
            () -> new RecordItem(3, ModSounds.FRANCE_ANTHEM, new Item.Properties().stacksTo(1), 2400));
    public static final RegistryObject<Item> GERMANY_ANTHEM_MUSIC_DISC = ITEMS.register("germany_anthem_music_disc",
            () -> new RecordItem(4, ModSounds.GERMANY_ANTHEM, new Item.Properties().stacksTo(1), 2400));

    public static final RegistryObject<Item> RUSSIA_ANTHEM_MUSIC_DISC = ITEMS.register("russia_anthem_music_disc",
            () -> new RecordItem(5, ModSounds.RUSSIA_ANTHEM, new Item.Properties().stacksTo(1), 2400));

    public static final RegistryObject<Item> MONGOLIA_ANTHEM_MUSIC_DISC = ITEMS.register("mongolia_anthem_music_disc",
            () -> new RecordItem(6, ModSounds.MONGOLIA_ANTHEM, new Item.Properties().stacksTo(1), 2400));

    public static final RegistryObject<Item> JAPAN_ANTHEM_MUSIC_DISC = ITEMS.register("japan_anthem_music_disc",
            () -> new RecordItem(7, ModSounds.JAPAN_ANTHEM, new Item.Properties().stacksTo(1), 2400));
    public static final RegistryObject<Item> AMERICA_ANTHEM_MUSIC_DISC = ITEMS.register("america_anthem_music_disc",
            () -> new RecordItem(8, ModSounds.AMERICA_ANTHEM, new Item.Properties().stacksTo(1), 2400));
    public static final RegistryObject<Item> CANADA_ANTHEM_MUSIC_DISC = ITEMS.register("canada_anthem_music_disc",
            () -> new RecordItem(9, ModSounds.CANADA_ANTHEM, new Item.Properties().stacksTo(1), 2400));
