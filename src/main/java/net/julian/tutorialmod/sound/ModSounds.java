...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> JAPAN_ANTHEM = registerSoundEvent("japan_anthem");
    public static final RegistryObject<SoundEvent> GERMANY_ANTHEM = registerSoundEvent("germany_anthem");
    public static final RegistryObject<SoundEvent> FRANCE_ANTHEM = registerSoundEvent("france_anthem");
    public static final RegistryObject<SoundEvent> RUSSIA_ANTHEM = registerSoundEvent("russia_anthem");
    public static final RegistryObject<SoundEvent> ROMANIA_ANTHEM = registerSoundEvent("romania_anthem");
    public static final RegistryObject<SoundEvent> MONGOLIA_ANTHEM = registerSoundEvent("mongolia_anthem");
    public static final RegistryObject<SoundEvent> CANADA_ANTHEM = registerSoundEvent("canada_anthem");
    public static final RegistryObject<SoundEvent> AMERICA_ANTHEM = registerSoundEvent("america_anthem");
